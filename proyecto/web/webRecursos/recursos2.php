...
if (isset($_SESSION["usuario"])) {
    ...
    if($usuario->esAdmin()) {
        header("Location:./administracionRecursos.php");
    }
} else {
...
if (isset($_FILES['archivo'])) {
    ...
    $destino = "./../../../../../ficheros_subidos/" . basename($_FILES['archivo']['name']);
...
?>
    <script>
        ...
        window.location.href = "recursos2.php";
    </script>
<?php
}
}
...
<body>
    <div class="container">
        ...
        <hr>
        <div id="ocultarTabla">
        <table class=" table1 table table-striped text-center mt-3 table-responsive table-hover contador">
