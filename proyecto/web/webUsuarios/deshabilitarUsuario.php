<?php
    ...
    /**
     * Si el usuario está logueado pero no es profesor, se redirige a la pagina principal
    ...
    $repositorio->DesactivarUsuarioPorId($idUsuarioBorrar); // Se actualiza el usuario
