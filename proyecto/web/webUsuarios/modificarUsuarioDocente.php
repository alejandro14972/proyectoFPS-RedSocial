<?php
   ...
   // print_r($usuario);
    ...
    //print_r($usuarioModificar->getNombre());
    //print_r($usuarioModificar->getRol());
    //print_r($usuarioModificar->getActivo());

    /**
     * Si se envía el formulario, se insertarán los nuevos datos del usuario en la Base de Datos
     */
    if(!empty($_POST)) {
        $usuarioModificar->setNombre($usuarioModificar->getNombre());
        ...
        $usuarioModificar->setActivo($usuarioModificar->getActivo());
...
<header class="row mb-3">
    ...
    <form action="<?= $_SERVER['PHP_SELF'].'?usuario_modificar='.$idUsuarioModificar; ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="Nombre usuario" name="nombre" disabled value="<?= $usuarioModificar->getNombre() ?>"><br>
